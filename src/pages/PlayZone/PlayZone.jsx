        ...
        <div className={styles.wrapper}>
          ...
          <ul className={styles.list}>
            {attractions.map(item => (
              <li className={styles.card} key={Math.random().toString()}>
                <div
                ...
                <p className={styles.description}>
                  ...
                  <span className={styles.descItem}>
                    Тариф:{" "}
                    <span className={styles.descItemResult}>{item.rate}</span>
                  </span>
                  <span className={styles.descItem}>
                    Ціна будній день :{" "}
                    <span className={styles.descItemResult}>
            ...
            {games.map(item => (
              <li className={styles.card} key={item.title.toString()}>
                <p className={styles.description}>
                  ...
                  <span className={styles.descItem}>
                    <span className={styles.descItemResult}>
                      Ціна по МегаПлей XL: {item.megaPlay} грн.
                    </span>
                  </span>
                </p>
              </li>
          ...
          {isModalOpen && (
            <Modal type="playZone" foto={foto} onClose={this.closeModal} />
          )}
